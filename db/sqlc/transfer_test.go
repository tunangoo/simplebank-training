...
func CreateRandomTranfer(t *testing.T, account1 Account, account2 Account) Transfer {
...
func TestGetTransfer(t *testing.T) {
	...
	require.WithinDuration(t, transfer2.CreatedAt.Time, transfer1.CreatedAt.Time, time.Second)
